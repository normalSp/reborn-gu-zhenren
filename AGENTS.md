...
- `v0.9.0` through `v1.3.0` are completed or locked milestones. Their phase lists, commit/run evidence, and detailed records are indexed in `指导大纲/historical-index.md`; do not treat old version docs as current gates unless AGENTS, PROJECT-STATE, current version docs, or a project-level process explicitly points to them.
...
For fuller current facts, read `.codex/skills/reborn-expert-council/references/PROJECT-STATE.md` first, then `指导大纲/v1.4.0/codex/00-总览/README.md`; use `指导大纲/historical-index.md` before opening old version phase lists.
