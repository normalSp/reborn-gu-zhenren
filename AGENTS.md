...
- `v0.14.0-b3` remote evidence update: implementation commit `540e196 feat: 展示v0.14阵营目标前置条件` has been pushed and GitHub Actions run `25992213170` passed. This supersedes any earlier pending wording for b3; next recommended step is `v0.14.0-b4 路线承接 UI 与摘要优先级`.
