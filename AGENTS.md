...
- `v1.0.0` public release prep started on 2026-05-20 after pre-v1.1 bug cleanup. New docs are `指导大纲/v1.0.0/codex/00-总览/v1.0.0-public-release-prep-启动检查.md` and `v1.0.0-public-release-prep-用户审批清单.md`. Lightweight public-candidate checks passed: production preview, runtime/Qingmao asset scans, player-visible-copy scan, and v0.19 content governance. The production preview still displays `v0.9.0`; changing package/title/game labels to `v1.0.0`, approving announcement copy, binding hero assets, using screenshots/short videos publicly, or executing EdgeOne public deployment requires user decision.
