...
- MiroFish handoff is now part of the phase gate for canon/IF/NPC/faction/route/hidden-fact work. Current v0.18 packages under `指导大纲/vMiroFish/intake-reviews/v0.18.0/` passed intake review and were absorbed only as RebornG-owned candidate/rule/test material. MiroFish output is not canon, not runtime authority, and not DeepSeek authority.
