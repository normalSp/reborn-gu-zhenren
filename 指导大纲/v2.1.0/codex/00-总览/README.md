...
状态：v2.1.0-a2 completed；等待 D-211 决策。
日期：2026-05-22
...
- 当前等待 D-211 决策；默认推荐批准 D-211-001、002、003、005、010、012，暂缓或拒绝 D-211-004、006、007、008、009、011。
...
下一步必须把 D-211 go/no-go 决策项交给用户拍板；在用户批准前，不进入 b1/offline runner、framework PoC、live eval、子代理、BFF/backend 或 runtime agent。
