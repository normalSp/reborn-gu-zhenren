...
状态：v2.1.0-a1 active；Agent Simulation Lab 启动版。
日期：2026-05-22
...
- 当前进入 `v2.1.0-a1-Claude-Code架构尽调.md` / `v2.1.0-a1-Agent框架吸收矩阵.md`。
- 用户消息中的“v2.0-a0”按 D-210 语义归一为 `v2.1.0-a0`，不回退历史 v2.0 阶段。
- 用户于 2026-05-22 明确要求进入 `v2.1.0-a1`；本阶段仍只做文档尽调，不引入依赖、runner、PoC、BFF/backend、live DeepSeek、子代理或 runtime agent。
