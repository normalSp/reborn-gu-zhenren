...
- 下一步：开 v2.4 专家团启动会，先讨论薄 BFF / private canon / eval archive infrastructure 边界，不直接进入 runtime agent。
...
建议开 v2.4 专家团启动会。v2.4 仍应先评估薄 BFF / private canon / eval archive infrastructure 边界；不要直接从 v2.3 跳到 runtime agent。
