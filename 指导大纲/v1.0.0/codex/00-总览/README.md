...
日期：2026-05-19
状态：a0/a1/a2 已完成，b1/b2/b3/b4 已通过本地质量门与远端 CI；process-1 本地 production smoke 已通过
主题：`活世界早期正式版`
...
| process-1 | EdgeOne 手动预览、回滚、错误观测最小清单 | 否或脚本 | 已完成，本地 production smoke 通过；不自动部署 |
