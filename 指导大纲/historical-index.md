...
4. 当前草案或最新完成版本入口，例如 `指导大纲/v2.2.0/codex/00-总览/README.md` 或 `指导大纲/v2.1.0/codex/00-总览/README.md`
...
| v2.2.0 | 当前 | Agent Lab 扩展离线模拟第一阶段 | `指导大纲/v2.2.0/codex/00-总览/` | D-220 / D-221 已记录；a1 场景模型门禁和 a2 memory/visibility/post-check 门禁完成；等待 D-222；不改 runtime，不写 runner 扩展，不调用 live DeepSeek |
